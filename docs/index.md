...
!!! warning "Alpha Development Version"
    Nova-VE is usable for early testing and feedback, but still expect incomplete features, workflow changes, and runtime instability.
